...
-- -----------------------------------------------------
-- Table `roadquality`.`LinearAcceleration`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `roadquality`.`LinearAcceleration` ;

CREATE TABLE IF NOT EXISTS `roadquality`.`LinearAcceleration` (
  `idLinearAcceleration` INT NOT NULL AUTO_INCREMENT,
  ...
  `y` FLOAT NULL,
  `z` FLOAT NULL,
  PRIMARY KEY (`idLinearAcceleration`),
